...
public class GoldMember extends BonusMember {
    ...
    public GoldMember(int memberNo, Personals personals, LocalDate enrolledDate, int bonuspoints, ArrayList<Points> bonuspointList)
    {
    ...
    public void registerPoints(int points, LocalDate date)
    {
        ...
        {
            bonuspointList.add(new Points((int) (points*FACTOR_GOLD), date));
            updatePoints();
        }
